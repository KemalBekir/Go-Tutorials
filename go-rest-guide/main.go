...
func main() {
	...
	// Create a new request miltiplexer
...
// RecipesHandler implements http.Handler and dispatches to the store
...
func (h *RecipesHandler) CreateRecipe(w http.ResponseWriter, r *http.Request) {
	// Recipe object that will be popupated from json payload
...
func (h *RecipesHandler) GetRecipe(w http.ResponseWriter, r *http.Request) {
	...
	// Conver the struct into JSON payload
